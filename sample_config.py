...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "MT_MyTelegramOrg_Bot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "MT_MyTelegramOrg_Bot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/Mo_Tech_YT")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/Mo_Tech_YT"
    )
    #
